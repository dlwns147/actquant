...
def get_model_type(model):
    from models.llama_autogptq import LlamaForCausalLM_KIVI
    LLAMA_KIVI_MODEL = LlamaForCausalLM_KIVI
    
    if isinstance(model, OPT_MODEL):
        model_type = OPT_MODEL
    elif isinstance(model, LLAMA_MODEL) or isinstance(model, LLAMA_KIVI_MODEL):
