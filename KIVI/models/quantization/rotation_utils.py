...
from models.quantization.hadamard_utils import random_hadamard_matrix, apply_exact_had_to_linear, is_pow2
from fast_hadamard_transform import hadamard_transform

use_ov_hadamard = None
use_headwise_hadamard = None
use_down_hadamard = None
...
def rotate_mlp_output(layer, Q, model_type):
    ...
    global use_down_hadamard
    if use_down_hadamard:
        # If the model don't use activation quantization, we don't need to apply exact hadamard on the weights of mlp output
...
def rotate_ov_proj(layer, model_type, head_num, head_dim):
    ...
    global use_headwise_hadamard
    if not use_headwise_hadamard:
...
def rotate_model(model, args):
    global use_ov_hadamard, use_headwise_hadamard, use_down_hadamard
    use_ov_hadamard = args.use_ov_hadamard
    use_headwise_hadamard = args.use_headwise_hadamard
    use_down_hadamard = args.use_down_hadamard
