...
W_EXPR=save/search/think/2608031514_Llama-3.1-8B-Instruct_wbits_kivi_sk8_w234kv4_gs128_r128_kd0_vd0_obj_2_5_st32_pp128/iter_200.stats
EFF_KV_EXPR=save/search/think/2608031514_Llama-3.1-8B-Instruct_eff_kvbits_kivi_think_sk8_w4kv234_gs3264128x2_128_r128_kd0to64x16_vd0to64x16_obj_0.1_5_st32_pp128/iter_190.stats
...
ITERATIONS=12       # PILOT length (production 200)
N_ITER=50          # candidates measured per iteration
SEED=${PILOT_SEED}
SAVE_ITER=2       # dump iter_<it>.stats + iter_<it>.png (via --debug) every SAVE_ITER iters (and the last)
...
COMPANION_KV=1       # WAFE: extra geometry-diverse KV archs attached per W-anchor at the subset
