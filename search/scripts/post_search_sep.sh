...
EXPR_FILE=( \
    save/search/quant/2505111531_Llama-2-7b-hf_wkv_loss_hqq_iter_200_w234k24v24bits_w128k128v128group_size_0res_len_k_channel_v_token_obj_22_55_jsd_co_0.9_mut_0.1_wikitext2_32sample_rbf/iter_200.stats \
    save/search/quant/2505271035_Llama-2-7b-hf_kv_loss_hqq_iter_100_w4k24v24bits_w128k128v128group_size_0res_len_k_channel_v_token_obj_2_5_jsd_co_0.9_mut_0.1_wikitext2_128sample_rbf/iter_70.stats
)
...
N_PROC=1
# N_PROC=2
CUDA_VISIBLE_DEVICES=${DEVICES} accelerate launch --num_processes=${N_PROC} --num_machines=1 --main_process_port=${PORT_NUM} post_search_sep.py \
--gpu_id ${DEVICES} \
