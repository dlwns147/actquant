...
def replace_attention_forward(self):
    def forward(
        ...
        **kwargs: Unpack[FlashAttentionKwargs],
        ...
        # - Prefill: keep full Q/K for attention; only compute keep_mask and pass to cache,
        #   so cache stores masked K (and V) consistent with decode-time GEMV/Fake paths.
