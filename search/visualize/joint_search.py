...
axes[1, 0].plot(our_llama_31_8b_inst_1048576_mem, our_llama_31_8b_inst_1048576_longbench, 'o-', label='Our Mixed-Precision', ms=marker_size, c=colors[0])
axes[1, 0].scatter(42137821184, 50.39125, label='w4g-1 / kv4g128', s=scatter_size, c=colors[1])
axes[1, 0].scatter(24957952000, 49.09, label='w4g-1 / kv2g128', s=scatter_size, c=colors[2])
