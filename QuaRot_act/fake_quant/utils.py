...
def parser_gen():
    ...
    parser.add_argument('--eval_datasets', type=str, nargs='+', default=['wikitext2', 'c4'], #default='wikitext2',
    ...
    parser.add_argument('--n_layer', type=int, default=32, help='')
    ...
    parser.add_argument('--fp16-out', action='store_true', 
                        help='')
    ...
    parser.add_argument('--sensitivity_file', type=str, default='', help='')
    parser.add_argument('--min_bits', type=int, default=2, help='')
    parser.add_argument('--eval_layerwise', action=argparse.BooleanOptionalAction, default=False,
                        help='evaluate ppl layerwise')
    parser.add_argument('--loss_dataset', type=str, default='wikitext2',
                        help='calibration data samples for measuring loss.', choices=supported_datasets)
    parser.add_argument('--eval_ppl', action=argparse.BooleanOptionalAction, default=False,
                        help='evaluate ppl when measuring linear sensitivity')
    parser.add_argument('--sensitivity_ppl_file', type=str, default='', help='')
    parser.add_argument('--loss_func', type=str, default='jsd', help='')
    parser.add_argument('--sensitivity_module', type=str, default='act', choices=['k', 'v', 'a'], help='')
